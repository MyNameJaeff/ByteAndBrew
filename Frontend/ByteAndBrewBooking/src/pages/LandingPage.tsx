    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-orange-50">
      ...
      <div className="text-center pt-16 pb-12">
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl sm:px-0 px-5 mx-auto leading-relaxed">
        ...
        <Link to="/booking">
          <button className="cursor-pointer group px-8 py-4 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
